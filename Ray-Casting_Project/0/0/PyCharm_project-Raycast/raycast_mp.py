...
class RayCast:
    ...
    def raycasting(self, npc_list, art_list, player_angle, player_x, player_y, process):
        ...
        for ray in range(80):
            ...
            for step in range(steps):
                ...
                if tile_v in self.map:
                    ...
                    break
                elif tile_v in npc_list:
                    self.texture_v = 'N'
                    break
                elif tile_v in art_list:
                    self.texture_v = 'A'
                    break
                X_vertical += delta_X
            ...
            for step in range(steps):
                ...
                if tile_h in self.map:
                    ...
                    break
                elif tile_h in npc_list:
                    self.texture_h = 'N'
                    break
                elif tile_h in art_list:
                    self.texture_h = 'A'
                    break
