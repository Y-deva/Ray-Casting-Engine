            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.QUIT:
                    ...
                    if _1((0, 0), event.pos, (SETTINGS.WIDTH // 20, 15 + SETTINGS.WIDTH // 20)):
                        ...
                        main2.return_sheet(prompt_file(), 'player_map.txt', step=2,
                        ...
                        text_map.files.append(file.name)
                    ...
                    if is_open:
                        text_map.text_map = open(text_map.files[text_map.n]).readlines()
